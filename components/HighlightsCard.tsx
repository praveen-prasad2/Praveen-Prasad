...
export default function HighlightsCard({ experiences }: HighlightsCardProps) {
  ...
  return (
    <BentoCard
      className="md:col-span-2 lg:col-span-4 flex flex-col justify-between bg-[radial-gradient(circle_at_bottom,_#f1fff4,_#ffffff)]"
      delay={0.18}
    >
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-3">
        {featuredExperiences.map((exp) => (
          <div key={exp.id} className="rounded-xl border border-gray-200 bg-white/70 px-4 py-4">
            <div className="flex flex-col gap-1">
              ...
              <span className="text-xs text-primary-600">{exp.period}</span>
            </div>
